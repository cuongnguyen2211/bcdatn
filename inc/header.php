                ...
                <div class="
                  ...
                  <div class="header-info-left d-flex align-items-center">
                    <div class="logo">
                      <a href="index.php">
                        ...
                        <img style="width:300px;" src="./assets/img/logoBC.png" alt="" data-pagespeed-url-hash="3800066785" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
                      </a>
                    </div>
                  ...
                  <div class="header-info-right d-flex align-items-center">
                    ...
                    <li><a href="#">Track Order</a></li> -->
                      ...
                      <li>
                        <a style="background-color: #ff1616; !important" target="_blank" href="admin/authen/login.php" class="btn header-btn">Login</a>
                      </li>
                    </ul>
                  </div>
                </div>
